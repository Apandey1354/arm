                ...
                {[
                  {
                    ...
                    imageAlt: "Law enforcement and security",
                  },
                  {
                    ...
                    imageAlt: "Search and find missing persons",
                  },
                ].map((item, index) => {
                    ...
                    >
                      ...
                      <div className="absolute inset-0 opacity-20 group-hover:opacity-30 transition-opacity duration-500">
                        <Image
                          ...
                          alt={item.imageAlt}
                          fill
                          className="object-cover rounded-[3rem] md:rounded-[4rem]"
                          sizes="(max-width: 768px) 280px, (max-width: 1024px) 300px, 320px"
                        />
                        <div className="absolute inset-0 bg-gradient-to-br from-primary/40 via-transparent to-red-500/40" />
                      </div>
                      ...
                      >
                        <motion.div
                          ...
                          className={`p-4 md:p-5 bg-gradient-to-br ${item.color} mb-4 md:mb-5 shadow-2xl ${item.hoverColor} transition-all duration-300 rounded-full relative z-20`}
                        >
                ...
                {[
                  {
                    ...
                    imageAlt: "Facial recognition and detection technology",
                  },
                  {
                    title: "Consultation",
                    ...
                    imageAlt: "Professional consultation and support",
                  },
                ].map((item, index) => {
                  const Icon = item.icon
                  return (
            ...
            {[
              {
                ...
                imageAlt: "Upload missing person information",
              },
              {
                step: "02",
                title: "AI Matching",
                ...
                image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop&q=80",
                imageAlt: "AI facial recognition matching",
              },
              {
                step: "03",
                ...
                imageAlt: "Law enforcement coordination",
              },
            ].map((item, index) => {
              const Icon = item.icon
              return (
                ...
                >
                  <Card className="h-full hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 border-2 hover:border-primary group bg-white dark:bg-gray-800 overflow-hidden relative">
                    {/* Background Image */}
                    ...
                    <CardHeader className="pb-4 relative z-10">
                      <div className="flex items-start gap-4 mb-4">
                        <motion.div
                          ...
                          className={`w-20 h-20 ${item.color} flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow flex-shrink-0`}
                        >
                          <Icon className="h-10 w-10 text-white" />
                        </motion.div>
                        <div className="flex-1">
                          <div className="text-xs font-black text-primary mb-2 uppercase tracking-widest">Step {item.step}</div>
                      ...
                      {/* Image Preview */}
                      <div className="relative h-48 rounded-lg overflow-hidden mb-4 border-2 border-gray-200 dark:border-gray-700 group-hover:border-primary transition-colors">
                        <Image
                          src={item.image}
                          alt={item.imageAlt}
                          fill
            ...
            {[
              {
                ...
                image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&h=400&fit=crop&q=80",
                imageAlt: "Urgent law enforcement response",
              },
              {
                ...
                imageAlt: "Community collaboration network",
              },
              {
                ...
                imageAlt: "Professional counseling and support",
              },
            ].map((item, index) => {
              const Icon = item.icon
              return (
                ...
                >
                  <Card className="h-full hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 border-2 border-gray-300 dark:border-gray-700 group bg-white dark:bg-gray-800 overflow-hidden relative">
                    {/* Background Image */}
                    <div className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity duration-300">
                      <Image
                        src={item.image}
                    ...
                    <CardHeader className="relative z-10">
                      {/* Image Header */}
                      <div className="relative h-48 rounded-lg overflow-hidden mb-6 border-2 border-gray-200 dark:border-gray-700 group-hover:border-primary transition-colors">
                        <Image
                          src={item.image}
                          alt={item.imageAlt}
                          fill
                        ...
                        <div className="absolute top-4 left-4">
                          <motion.div
                            whileHover={{ scale: 1.1, rotate: -5 }}
                            className="p-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-lg"
                          >
                            <Icon className="h-8 w-8 text-primary" />
                          </motion.div>
                        </div>
                        <div className="absolute bottom-4 right-4 text-right">
                          <div className="text-3xl font-black text-white drop-shadow-lg group-hover:scale-110 transition-transform">{item.stat}</div>
                          <div className="text-xs font-bold text-white/90 uppercase tracking-wider drop-shadow">{item.statLabel}</div>
                        </div>
                      </div>
                      <CardTitle className="text-2xl font-black uppercase tracking-tight group-hover:text-primary transition-colors">{item.title}</CardTitle>
                    </CardHeader>
